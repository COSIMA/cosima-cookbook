...
def upgrade():
    ...
    op.create_table('keywords',
                    ...
                    sa.Column('_keyword', sa.String(collation='NOCASE'), nullable=False),
                    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_keywords__keyword'), 'keywords', ['_keyword'], unique=True)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_keywords__keyword'), table_name='keywords')
